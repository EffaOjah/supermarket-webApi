...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2025 at 07:02 PM
...
--
-- Table structure for table `employee_salary_config`
--
...
--
-- Table structure for table `payroll_backup_legacy`
--

CREATE TABLE `payroll_backup_legacy` (
...
CREATE TABLE `payslips` (
  ...
  `total_allowances` decimal(15,2) DEFAULT NULL,
  `total_deductions` decimal(15,2) DEFAULT NULL,
...
INSERT INTO `salary_components` (`component_id`, `name`, `type`, `is_taxable`, `is_fixed`, `active`) VALUES
(1, 'Basic Salary', 'Earning', 1, 1, 1),
(2, 'Housing Allowance', 'Earning', 1, 1, 1),
(3, 'Transport Allowance', 'Earning', 1, 1, 1),
(4, 'Medical Allowance', 'Earning', 1, 1, 1),
(5, 'Overtime', 'Earning', 1, 1, 1),
(6, 'PAYE Tax', 'Deduction', 0, 1, 1),
(7, 'Pension', 'Deduction', 0, 1, 1),
(8, 'Loan Repayment', 'Deduction', 0, 1, 1);
...
CREATE TABLE `salary_structure_components` (
  ...
  `percentage_of_basic` decimal(5,2) DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('5f51732a-3b5d-11f0-88dd-bc2411d9ced4', 'HEAD OFFICE', '', '2025-05-28 00:49:05', '2025-12-10 17:54:29'),
('5f518471-3b5d-11f0-88dd-bc2411d9ced4', 'WATT', '', '2025-05-28 00:49:05', '2025-12-05 17:18:38'),
('69ecb3ff-3b5d-11f0-88dd-bc2411d9ced4', 'MARIAN', '', '2025-05-28 00:49:22', '2025-12-08 17:12:03'),
...
--
-- Indexes for table `employee_salary_config`
--
...
--
-- Indexes for table `payroll_backup_legacy`
--
ALTER TABLE `payroll_backup_legacy`
...
--
-- Indexes for table `salary_structure_components`
--
...
--
-- AUTO_INCREMENT for table `employee_salary_config`
--
ALTER TABLE `employee_salary_config`
...
--
-- AUTO_INCREMENT for table `salary_structure_components`
--
ALTER TABLE `salary_structure_components`
...
--
-- Constraints for table `employee_salary_config`
--
ALTER TABLE `employee_salary_config`
  ADD CONSTRAINT `employee_salary_config_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `employee_salary_config_ibfk_2` FOREIGN KEY (`structure_id`) REFERENCES `salary_structures` (`structure_id`);
...
--
ALTER TABLE `loans`
  ADD CONSTRAINT `loans_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`);

--
-- Constraints for table `payslips`
--
ALTER TABLE `payslips`
  ADD CONSTRAINT `payslips_ibfk_1` FOREIGN KEY (`run_id`) REFERENCES `payroll_runs` (`run_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `payslips_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `salary_structure_components`
  ADD CONSTRAINT `salary_structure_components_ibfk_1` FOREIGN KEY (`structure_id`) REFERENCES `salary_structures` (`structure_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `salary_structure_components_ibfk_2` FOREIGN KEY (`component_id`) REFERENCES `salary_components` (`component_id`);
